...
| `STYLEGUIDES_DIR` | `<BOOKS_DIR>/.styleguides` | Uploaded and LLM-generated style guides (persists in the books volume by default). Bundled presets are read from the read-only `assets/styleguides/` regardless. |
